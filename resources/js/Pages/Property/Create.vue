                ...
                <span class="hidden sm:block">
                   <button type="button"
                    ...
                    <span class="hidden sm:block ml-3">
                        <!--                            :href="route('property.show', $page['props']['property']['uuid'])"-->
                        <inertia-link
                ...
                <div>
                    <form-section @submitted="updateProfileInformation">
                        ...
                        <template #description>
                            Update the street address and description.
                        </template>
                        ...
                        <template #form>
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <!--Street Address 2-->
                                <jet-label for="street2" value="Street Address 2 (Optional)"/>
                                <jet-input id="street2" type="text" class="mt-1 block w-full"/>
                            </div>
