                        ...
                        <li v-for="(topic, index) in $page['props']['topics']" class="group">
                            ...
                            <div class="bg-gray-50 sm:rounded-lg">
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <ul v-if="$page['props']['questions'][index]['questions'].length">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div v-if="addQuestion"
                                             class="flex-row inline-flex items-center font-medium rounded-md text-gray-700 sm:text-sm">
                                            ...
                                            <button type="button" @click="addQuestion=!addQuestion"
                                                    class="inline-flex items-center ml-2 px-4 py-2 border border-gray-300 shadow-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm">
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
