            ...
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <div>
                    ...
                    <div class="bg-white shadow sm:rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="mt-2 max-w-xl text-sm text-gray-500">
                                <p>
                                    These are how customers will interact with your page and how you'll generate leads.
                                </p>
                            </div>
                            <div class="mt-5">
                                <div class="relative inline-block text-left">
                                    <button type="button" @click="createLink=!createLink"
                                    ...
                                    <transition
                                        ...
                                        <div class="fixed z-10 inset-0 overflow-y-auto " v-show="createLink">
                                            <div
                                                ...
                                                <transition
                                                    ...
                                                    <div v-if="createLink"
                                                            ...
                                                            <div class="mt-3 text-center sm:mt-5">
                                                                ...
                                                                <div class="mt-2">
                                                                    <div class="col-span-6 sm:col-span-4">
                                                                        <jet-label for="title" value="Description"/>
                                                                        <jet-input type="text"
                                                                        ...
                                                                        <jet-label class="mt-2" for="title"
                                                                                   value="URL"/>
                                                                        <jet-input type="text"
                                                        ...
                                                        <form @submit.prevent="addLink.post('/site/create-link')">
                                                            <div
                                                                class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">

                                                                <!--LOADING-->
                                                                <template v-if="createLink.processing">
                                                                    <!--                                                    <span class="sm:ml-3">-->
                                                                    <button type="submit"
                                                                ...
                                                                <!--COMPLETED-->
                                                                <template v-else-if="createLink.recentlySuccessful">
                                                                    <!--                                                    <span class="sm:ml-3">-->
                                                                    <button type="submit"
                                                                            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:col-start-2 sm:text-sm">
                                                                        <!-- Heroicon name: solid/check -->
                    ...
                    <ul v-if="$page['props']['links'].length"
                        ...
                        <li v-for="(link, index) in $page['props']['links']" class="group">
                            <!-- This example requires Tailwind CSS v2.0+ -->
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="mt-5 flex justify-between">
                                        ...
                                        <transition
                                            ...
                                            leave-class="opacity-100"
                                            leave-to-class="opacity-0">
                                            <div class="fixed z-10 inset-0 overflow-y-auto " v-show="openLink">
                                                <div
                                                    class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                                    <!--
                                                      Background overlay, show/hide based on modal state.
                                                        ...
                                                        <div v-if="openLink"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mt-3 text-center sm:mt-5">
                                                                    ...
                                                                    <div class="mt-2">
                                                                        <div class="col-span-6 sm:col-span-4">
                                                                            <jet-label for="title" value="URL"/>
                                                                            <jet-input type="text"
                                                                                       :value="link.url"
                                                                                       v-on:input="updateLink.url = $event; updateLink.link_id = link.id"
                                                                                       class="mt-1 block w-full"/>
                                                                        </div>
                                                            ...
                                                            <form
                                                                @submit.prevent="updateLink.post('/site/update-link')">
                                                                <div
                                                                    class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                        ...
                                        <form @submit.prevent="deleteLink.post('/site/delete-link')">


                                            <button :value="link.id"
                                                    @click="deleteLink.link_id = $event.target.value"
                                                    type="submit"
                    ...
                    <p v-else class="mt-2 max-w-4xl text-sm text-gray-500">
                        You haven't added any links yet. Click the create link button on the top of the page to get
                        started!
                    </p>
                    ...
                    <ul v-if="$page['props']['topics'].length"
                        class="space-y-12 sm:grid sm:grid-cols-1 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-1 lg:gap-x-8">
                        <li v-for="(topic, index) in $page['props']['topics']" class="group">
                            <!-- This example requires Tailwind CSS v2.0+ -->
                            <div class="bg-gray-50 sm:rounded-lg">
                                <div class="px-4 py-5 sm:p-6">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                                    ...
                                    <div v-if="$page['props']['questions'][index]['questions'].length == 1"
                                         class="mt-2 max-w-xl text-sm text-gray-500">
                                        <p>
                                            {{
                                                $page['props']['questions'][index]['questions'].length + " question"
                                            }}
                                        </p>
                                    </div>

                                    <div v-else-if="$page['props']['questions'][index]['questions'].length > 1"
                                         class="mt-2 max-w-xl text-sm text-gray-500">
                                        <p>
                                            {{
                                                $page['props']['questions'][index]['questions'].length + " questions"
                                            }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="mt-5 flex justify-between">
                                        ...
                                        <inertia-link :href="route('site.form.edit', {
                                        ...
                                        <form @submit.prevent="form.post('/site/delete-form')">


                                            <button :value="topic.id"
                                                    @click="form.topic_id = $event.target.value"
                                                    type="submit"
                                                    class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm">
                                                Delete
                                            </button>
                    ...
                    <!-- IN CASE THERE ARE NONE -->
                    <p v-else class="mt-2 max-w-4xl text-sm text-gray-500">You haven't made any forms yet. Click the
                        create form button on the top to get started!</p>
...
export default {
    ...
    data: function () {
        return {
            ...
            deleteLink: this.$inertia.form({
                link_id: 0,
                site_id: this.site.id,
            }),

            updateLink: this.$inertia.form({
                url: '',
                link_id: 0,
                site_id: this.site.id,
            }),

            addLink: this.$inertia.form({
                url: '',
                title: '',
                site_id: this.site.id,
            })
